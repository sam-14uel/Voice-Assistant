...
const socket = new WebSocket('ws://localhost:8000/ws/conversation/Lzt5jyvV557AcXqL65UFRJ/');
...
function displayMessage(messageData) {
  ...
  } else if (sender === 'AI_Assistant' || sender === 'AI_Assistant') {
  ...
  if (sender === 'samuelobinnachimdi') {
    identityEl.innerHTML = '<i class="user-icon">U</i>';
  } else if (sender === 'AI_Assistant' || sender === 'AI_Assistant') {
